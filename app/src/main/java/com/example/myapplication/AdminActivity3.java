...
public class AdminActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.admin_ac3);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            channel.setDescription("Notifications for new activity added");
    ...
    private void addServiceToDatabase() {
        ...
        databaseReference.child(name).setValue(Service)
                .addOnSuccessListener(aVoid -> {
                    ...
                    Intent intent = new Intent(AdminActivity3.this, AdminActivity.class);
    ...
    private void sendNotification(String name, String  Price) {
        ...
        try {
            ...
            NotificationCompat.Builder builder = new NotificationCompat.Builder(this, CHANNEL_ID)
                    ...
                    .setContentTitle("New Activity Added: " + name)
